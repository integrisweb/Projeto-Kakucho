...
?>
    ...
    <main class="ls-main">
      <div class="container-fluid">
        <h1 class="ls-title-intro ls-ico-tree">Parentesco</h1>

        <form action="" class="ls-form row" id="formParenteso">
          <input type="hidden" name="table_id" id="table_id" value="0"/>
        
          <fieldset>
            <label class="ls-label col-md-4">
              <b class="ls-label-text">Parentesco</b>
              <input type="text" name="nome" id="nome" placeholder="Parentesco" required>
            </label>
          </fieldset>
